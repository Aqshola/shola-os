...
interface PropsContentPortfolioContentWindow {
    projectId: string;
    selectedProject: Accessor<Portfolio | null>;
    loading: Accessor<boolean>;
    onClose: () => void;
...
function ContentPortfolioContentWindow(props: PropsContentPortfolioContentWindow) {
